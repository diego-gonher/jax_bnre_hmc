...
best_dir = '/Users/diegogonzalez/Documents/Research/ENIGMA/BNRE-HMC/jax_bnre_hmc/outputs/amber501_p1d/2026-03-15_13-11-30/checkpoints/best/'
...
dataset_file = f'/Users/diegogonzalez/Documents/Research/ENIGMA/BNRE-HMC/jax_bnre_hmc/datasets/amber501/mocks_z5.00_snr30.0.hdf5'

print(f"\nLoading dataset from {dataset_file}")

with h5py.File(dataset_file, "r") as f:
    # load the needed arrays
    params_all = f['params'][:, :5]                  # (4509, 5)
